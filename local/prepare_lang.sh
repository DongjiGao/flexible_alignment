...
# Dongji: Replace phones.txt for huggingface model
#./local/make_phones.py vocab.json $dir
#cat ${dir}/phones/disambig.txt | awk '{n=NR-1; print $1, n+42;}' >> $dir/phones.txt
